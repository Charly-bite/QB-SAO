...
class TestStatusTransitions:
    ...
    def test_update_status_appends_history(self, osm):
        osm.update_status('5001', 'Preparando', 'operator1', 'Picking')
        history = osm.get_order('5001')['status_history']
        last = history[-1]
        assert last['status'] == 'Preparando'
...
class TestImportFromSAP:
    ...
    def test_reimport_preserves_local_status(self, osm):
        ...
        osm.update_status('5001', 'Preparando', 'admin', 'Advanced')
        ...
        assert result['status'] == 'Preparando'  # preserved
...
class TestStatusNormalization:
    ...
    def test_legacy_label_migration(self, osm):
        ...
        assert osm.orders['7001']['status'] == 'Recibido por almacen'
