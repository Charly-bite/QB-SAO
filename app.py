"""
Seguimiento Web — Order Tracking Application
...
log_file = os.path.join(os.path.dirname(os.path.abspath(__file__)), 'logs', 'seguimiento.log')
logging.basicConfig(
    level=logging.INFO,
...
from core.order_status_manager import OrderStatusManager, OrderStatus
...
if __name__ == '__main__':
    print("=" * 60)
    print("📦  Seguimiento Web — Order Tracking System")
    print("=" * 60)
